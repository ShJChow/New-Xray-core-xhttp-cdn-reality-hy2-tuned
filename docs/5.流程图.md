...
graph TD
	...
	XR443C -->|"非 Reality<br/>fallback name=CDN_DOMAIN → 8003"| NG8003["Nginx 8003<br/>server_name: CDN_DOMAIN"]
	...
	XR443C2 -->|"非 Reality<br/>fallback name=CDN_DOMAIN → 8003"| NG8003C["Nginx 8003<br/>server_name: CDN_DOMAIN"]
	...
	DS5 --> DS5FW["穿过防火墙"] --> DS5CDN["Cloudflare CDN"] --> DS5XR443["Xray 443<br/>非 Reality<br/>fallback name=CDN_DOMAIN → 8003"] --> DS5NG["Nginx 8003<br/>server_name: CDN_DOMAIN"] --> DS5PATH{"location 匹配<br/>XHTTP_PATH?"}
